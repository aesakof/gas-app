...
urlpatterns = [
    ...
    path('profile/fillups/',views.UserFillupListView.as_view(),name='user_fillup_list'),
    path('profile/cars/',views.UserCarListView.as_view(),name='user_car_list'),
    path('profile/stats/',views.UserStatsView.as_view(),name='user_stats'),
    path('profile/fillups/edit/<int:pk>/',views.UpdateFillup.as_view(success_url='/profile/fillups/'),name='update_fillup'),
    path('profile/fillups/delete/<int:pk>/',views.FillupDeleteView.as_view(),name='delete_fillup'),
    path('profile/cars/edit/<int:pk>',views.UpdateCar.as_view(success_url='/profile/cars/'),name='update_car'),
    path('profile/cars/delete/<int:pk>',views.CarDeleteView.as_view(),name='delete_car'),
